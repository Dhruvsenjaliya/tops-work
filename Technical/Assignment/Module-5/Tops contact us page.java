...
public class Test101Test {
  ...
  public void test101() {
    ...
    driver.findElement(By.id("inq_name")).sendKeys("Shiv Parejiya");
    driver.findElement(By.id("inq_email")).click();
    driver.findElement(By.id("inq_email")).sendKeys("shivparejiya2@gmail.com");
    driver.findElement(By.id("inq_contact")).click();
    driver.findElement(By.id("inq_contact")).sendKeys("9725465485");
